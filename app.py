...
st.markdown(
    ...
    /* FIX DE CONTRASTE DOS BOTÕES E INPUTS */
    ...
    /* Botão Principal (Vermelho visível) */
    ...
    /* Botão Secundário (Borda e texto escuro para não sumir no fundo) */
    div.stButton > button {
        background-color: #ffffff !important;
...
if itens_carrinho and st.session_state["etapa_pedido"] == "dados_entrega":
    ...
    # ROLAGEM AUTOMÁTICA GARANTIDA VIA JAVASCRIPT
    components.html(
        """
        <script>
            setTimeout(function() {
